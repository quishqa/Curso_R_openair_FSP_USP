...
- Existem outras funçãoes que não precisam do argumento `parameters` pois foram disenhados para baixar parâmetros específicos:
...
- _Uma figura vale mais do que 100 palabras_.
- Vamos aprofundizar como usar **R Base Graphics** para criar os plots.
- Seguires as _10 simple rules for better figures_ do [**Rougier et al. (2014)**](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1003833)
...
## Séries temporais
- Vamos a plotar a série temporal da concentrações de pm10.
```{r, out.height="60%"}
...
points(who_sp$year, who_sp$pm10, col = "orange",
       pch = 19 )# tipo do ponto
```
...
```{r, eval=FALSE}
plot(who_sp$year, who_sp$pm10,  # Dado eixo x, dado eixo y
     t = "l", lwd = 2.5, col = "orange", 
     ylim = c(10, 40), # para visualizar valores de PM2.5
     xlab = "Anos", main = "São Paulo",
     ylab = "[ug/m3]") # So unidades
points(who_sp$year, who_sp$pm10, col = "orange", pch = 19 )
# Adicionamos PM.25
lines(who_sp$year, who_sp$pm25, col = "red", lwd = 2.5)
points(who_sp$year, who_sp$pm25, col = "red", pch = 19 )
```
...
- Adicionemos também PM$_{2.5}$
```{r, eval=FALSE}
plot(who_sp$year, who_sp$pm10,t = "l", lwd = 2.5, col = "orange", 
     ylim = c(10, 40), xlab = "Anos", main = "São Paulo", ylab = "[ug/m3]")
points(who_sp$year, who_sp$pm10, col = "orange", pch = 19 )
lines(who_sp$year, who_sp$pm25, col = "red", lwd = 2.5)
points(who_sp$year, who_sp$pm25, col = "red", pch = 19 )
legend("topright", col = c("orange", "red"), lwd = 2.5, 
       legend = c("PM10", "PM25"))
```
