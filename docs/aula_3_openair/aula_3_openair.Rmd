...
calendarPlot(selectByDate(dado, 
             year = 2019, month = c("jun","jul","ago")), #seleciona o ano/mês desejado
...
Plotar um timePlot com as concentrações de O3 e NO2 separando com uma linha vertical o período de 01 a 22 de março de 2020 (pré-lockdwon) e de 23 de março em diante (Lockdown).
Usando o splitByDate e o timeVariation, avaliar se houve diferença entre as concentrações de O3 e NO2 quanto ao perfil diurno (hour) e dia da semana (day.hour). Exportar as figuras ao final.
